<template>
  <div id="nearby_parts">
    ...
    <div class="nearby_item" v-for="item in nearbyList.value" :key="item.id">
      <img :src="item.imgUrl" class="nearby_item_img" @click="toShop(item)" />
...
export default {
  ...
  setup() {
    ...
    const {toShop}=toShopEffect(item);
