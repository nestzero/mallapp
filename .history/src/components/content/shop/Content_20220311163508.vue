...
// 购物车相关逻辑
const useCartEffect = () => {
  const { cartList, changeCartItemInfo,getProductCartCount,changeShopName,shopName } = useCommonCartEffect()
  ...
  return { cartList, changeCartItem,getProductCartCount,shopName }
}
