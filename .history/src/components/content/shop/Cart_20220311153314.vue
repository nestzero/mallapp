  ...
  <div id="cart">
        ...
        <div class="product_item" v-if="item.count > 0">
          ...
          <div class="product_number">
            <span
              ...
              @click="
                () => {
                  changeCartItem(shopId, item._id, item,shopName);
                }
              "
              >-</span
            >
    ...
    <div class="cart_content">
      ...
      <div class="cart_content_btn" v-show="calculations.total > 0">
        <router-link :to="{ path: `/order/${shopId}/${props.shopName}` }"> 去结算 </router-link>
      </div>
    </div>
  </div>
</template>
...
const useCartEffect = (shopId) => {
  ...
  return { productList, calculations, changeCartItem };
};
...
export default {
  ...
  setup(props) {
    ...
    const { productList, calculations, changeCartItem } =
