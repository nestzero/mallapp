...
const useCartEffect = (shopId) => {
  ...
  const { cartList,productList,calculations,changeCartItemInfo } = useCommonCartEffect();

  return { calculations, productList,calculations, changeCartItemInfo };
};
...
const toggleCartEffect = () => {
  ...
  return { showCart, handleCartShowChange,changeCartItemChecked,cleanCartProducts,setCartItemsChecked };
};
...
export default {
  setup() {
    ...
    return {
      ...
      changeCartItemInfo,
      showCart,
      handleCartShowChange,changeCartItemChecked,cleanCartProducts,setCartItemsChecked
    };
  },
};
</script>
